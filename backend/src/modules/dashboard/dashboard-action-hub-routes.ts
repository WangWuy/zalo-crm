    ...
    try {
      ...
      const [overdueAppts, tomorrowAppts, birthdayRows] = await Promise.all([
        prisma.appointment.findMany({
          ...
          select: { id: true, title: true, appointmentDate: true, appointmentTime: true, location: true, contact: { select: { id: true, fullName: true, phone: true } } },
      ...
      const apptItem = (a: { id: string; title: string | null; appointmentDate: Date; appointmentTime: string | null; location: string | null; contact: { id: string; fullName: string | null; phone: string | null } | null }) => ({
