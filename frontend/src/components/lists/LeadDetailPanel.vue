      ...
      <div class="ldp-panel" :class="{ 'ldp-loading': loading }">
        ...
        <header class="ldp-head">
          <div class="ldp-head-top">
            ...
            <div class="ldp-head-info">
              ...
              <div v-if="data?.entry.phoneLocal || data?.entry.phoneE164" class="ldp-phone">
                ...
                <a class="ldp-phone-btn call" :href="buildCallHref(data.entry.phoneE164 || data.entry.phoneLocal || '')" title="Gọi">📞</a>
              </div>
          ...
          <div class="ldp-actions">
            ...
            <a class="ldp-btn-ghost" :class="{ disabled: !canCall }" :href="canCall ? buildCallHref(data?.entry.phoneE164 || data?.entry.phoneLocal || '') : undefined">📞 Gọi</a>
...
import { useDialer } from '@/composables/use-dialer';
