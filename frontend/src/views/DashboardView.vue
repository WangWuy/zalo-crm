  ...
  <div class="airtable-scope dh-v4">
    ...
    <div class="at-dash-body">
      ...
      <div v-show="activeTab === 'me'" class="dh-tabpanel">
        <!-- Phase 1 Ca làm việc & Báo cáo ca 2026-08-21 -->
        <ShiftDeadlineWidget />
            ...
            <div class="at-card">
              ...
              <div class="at-card__body">
                <div v-for="a in me?.reminders?.overdue ?? []" :key="'ov'+a.id" class="at-list-row" @click="goToAppts">
                  ...
                  <div class="at-list-row__rt-group">
                    <QuickContactActions v-if="a.contactPhone" :phone="a.contactPhone" call-mode="programmatic" />
...
import QuickContactActions from '@/components/shared/QuickContactActions.vue';
import ShiftDeadlineWidget from '@/components/dashboard/ShiftDeadlineWidget.vue';
import {
