...
const {
  ...
  loadingConvs, loadingMsgs, hasMoreMessages, loadingOlderMsgs, sendingMsg, searchQuery, accountFilter, extraFilters,
  aiSuggestion, aiSuggestionLoading, aiSuggestionError,
  aiSummary, aiSummaryLoading, aiSentiment, aiSentimentLoading,
  fetchConversations, fetchAiConfig, fetchMessages, loadOlderMessages, selectConversation, sendMessage,
