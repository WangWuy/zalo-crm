...
export const SETTINGS_GROUPS: SettingsGroup[] = [
  ...
  // ─── KÊNH & TỰ ĐỘNG ──────────────────────────────────
  {
    ...
    items: [
      ...
      { id: 'facebook-pages', label: 'Facebook Lead Ads', icon: 'mdi-facebook', route: '/settings/channels/facebook', permission: 'admin', resource: 'settings', aliases: ['facebook', 'lead ads', 'fb', 'webhook facebook'] },
